...
enable_idle_drift()
{
	if (flag("allow_vo"))	// This makes sure we are past any initial config screens
	{
		/#
			...
			{
				//IPrintLn("Idle drift enabled");  //Changes made June 16th 2020. Don't want player's vision to get distracted by this noti.
			}
		#/
...
disable_idle_drift()
{
	/#
		if (flag("enable_idle_drift"))
		{
			//IPrintLn("Idle drift disabled"); //Changes made June 16th 2020. Don't want player's vision to get distracted by this noti.
		}
	#/
