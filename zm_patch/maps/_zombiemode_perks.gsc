...
vending_trigger_think()
{
	...
	case "specialty_armorvest":
		cost = 2500; //250 for recording purposes //leave as default when publishing, Ultimateman
		break;
	...
	case "specialty_quickrevive":
		if( solo )
		{
			cost = 250; //leave as 250 for solo players
		}
		else
		{
			cost = 500; //250 for recording purposes //leave as default when publishing, Ultimateman
		}
		break;

	case "specialty_fastreload_upgrade":
	case "specialty_fastreload":
		cost = 3000; //250 for recording purposes //leave as default when publishing, Ultimateman
		break;

	case "specialty_rof_upgrade":
	case "specialty_rof":
		cost = 2000; //250 for recording purposes //leave as default when publishing, Ultimateman
		break;
	...
	case "specialty_flakjacket":
		cost = 2000; //not changed
		break;
		
	case "specialty_deadshot_upgrade":
	case "specialty_deadshot":
		cost = 250; // shit perk so give it a shit prize
		break;
		
	case "specialty_additionalprimaryweapon_upgrade":
	case "specialty_additionalprimaryweapon":
		cost = 4000; //250 for recording purposes //leave as default when publishing, Ultimateman
		break;
