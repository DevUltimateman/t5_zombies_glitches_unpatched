	...
	for( i = 0; i < respawn_points.size; i++ )
	{
		if ( respawn_points[i].script_noteworthy == "storage_lander_zone" )
		{
			...
			for( j = 0; j < respawn_positions.size; j++ )
			{
				...
				{
					respawn_positions[j].origin = (0, 0, 0);
				}		
			}	
		}
	}
