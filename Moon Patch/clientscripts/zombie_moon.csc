...
main()
{
	...
	level._moon_exterior_vision_set = "zombie_moonTunnels"; //OG zombie_moon
	level._moon_exterior_vision_set_priority = 5;	
	
	level._moon_interior_vision_set = "zombie_moonTunnels";
	level._moon_interior_vision_set_priority = 5;	
	
	level._moon_biodome_vision_set = "zombie_moonBioDome";  //moonBioDome
	...
	level._moon_hanger18_vision_set = "zombie_moonTunnels";
