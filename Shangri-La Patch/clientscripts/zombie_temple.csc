...
main()
{
	...
	level._temple_vision_set = "zombietron_afternoon";  //orignally set to zombie_temple, Changes made June 13th 2020. //zombietron_afternoon seems to be the best option
	level._temple_vision_set_priority = 1;
	
	level._temple_caves_vision_set = "zombietron_temple_eclipseCave"; //originally set to zombie_temple_caves, Changes made June 15th 2020.
	level._temple_caves_vision_set_priority = 2;
	
	level._temple_water_vision_set = "zombietron_afternoon"; //"creek_1_water"; = zombie_temple // Changed to zombietron_afternoon as of 13th June 2020.
	
	level._temple_eclipse_vision_set = "zombie_temple_eclipse";
	level._temple_eclipse_vision_set_priority = 2;
...
strobe_sky_and_transition(end_val)
{
	...
	for(i = 0; i < 10; i ++)
	{
		//SetSavedDvar( "r_skyTransition", val);  //Commented out on June 15th 2020.
		val = 1.0 - val;
	...
	//SetSavedDvar( "r_skyTransition", end_val );  //Commented out on June 15th 2020.
...
daybreak_watcher()
{
	while(1)
	{
		...
		if(!IsDefined(level.first_sky_trans))
		{
			...
			//SetSavedDvar( "r_skyTransition", 0.0 );  //Commented out on June 15th 2020.
		}
		else
		{
