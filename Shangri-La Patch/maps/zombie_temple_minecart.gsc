...
minecart_link_passengers()
{
	...
	if ( IsDefined(self.cage_door) ) 
	{
		self.cage_door NotSolid(); //Changes made from solid to notsolid //June 13th 2020.
	}
...
player_minecart_ride(minecart)
{
	...
	self.is_on_minecart = false; //Change to false if the player unlink doesnt work. 14th June 2020.
	...
	else
	{
		...
		//self playerLinkToMineCart(360); //Changes made on June 13th 2020.
		wait(1.0);
	}
	...
	//self thread minecart_screen_shake(); //Changes made on June 13th 2020.
...
playerLinkToMineCart(view_yaw)
{
	...
	//self PlayerLinkToDelta( self.minecart_link, "tag_origin", 1, view_yaw, view_yaw, 90, 75, true ); //Changes made on 14th June 2020.
...
minecart_lever_think()
{
	...
	while(1)
	{
		...
		self.minecart thread _minecart_close_door(); //CHANGED ON JUNE 14TH 2020.
		...
		self.minecart thread _minecart_nuke();
		
		//Put front gate back up
		//self.minecart thread _minecart_close_front_door_delay(10.0);
