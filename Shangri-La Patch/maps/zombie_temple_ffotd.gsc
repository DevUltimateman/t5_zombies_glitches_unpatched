...
main_start()
{
	...
	//PreCacheModel("collision_wall_256x256x10"); //Changes made on June 12th 2020
}
...
main_end()
{
	...
	//collision = spawn("script_model", (1623, -668, 114));   //Changes made on June 12th 2020
	//collision setmodel("collision_wall_256x256x10");         //Changes made on June 12th 2020
	//collision.angles = (0, 0, 0);                           //Changes made on June 12th 2020
	//collision Hide();      made on June 12th 2020


    /*
	level.timed_killbrush_in_start_area_geyser = maps\_zombiemode::spawn_kill_brush( (-25, -1025, -175), 90, 170 );        //Changes made on June 12th 2020
	level.timed_killbrush_in_minecart_area_geyser = maps\_zombiemode::spawn_kill_brush( (1092, -1000, -100), 60, 90 );    //Changes made on June 12th 2020
	level.player_out_of_playable_area_monitor_callback = ::zombie_temple_player_out_of_playable_area_monitor_callback;   //Changes made on June 12th 2020
	*/
}
