...
on_power_on()
{
	...
	level thread minecart_glitch_txt();
...
//-----------------------------------------------------------------------------
//name:    minecart_glitch_txt
//return:  nothing
//desc:    notify player about the secret minecart glitch he/she just unlocked.
//-----------------------------------------------------------------------------
minecart_glitch_txt()
{
	IPrintLnBold("Secret ^6minecart ^7glitch ^2unlocked^7!");
	wait 0.01;
	IPrintLnBold("^3Go ^7ahead & ^3ride ^7the ^3minecart^7...");
}
